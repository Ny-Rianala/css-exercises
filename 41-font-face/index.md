...
`@keyframes`works foer animation.  
`@media`for screens and make it to be responsive.  
`@supports`let us specify declarations that depends on the browser's support -MDN web docs.  
...
We should try until it stop in the available font.
